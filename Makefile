...
SOURCES            = main.c myLib.c game.c StartScreen.c InstructionScreen.c EndScreen.c EndUI.c PauseScreen.c spritesheet.c collisionmap.c bg.c UI.c Bubbles.c FishtankBubbles.c Technique.c FUNsong.c Tomfoolery.c Coin.c Money.c Screaming.c Whoosh.c
